...
// pembuatan class orang (Base Class)
class orang {
public:
...
// pembuatan class pelajar sebagai pewaris dari class orang (Derived Class)
...
public:
    ...
    // constructor memanggil constructor orang(pNama) untuk inisialisasi nama
